...
const expects = {
    ...
    string: {
        contains: () => {
            throw new StubError('expects.string.contains')
 ...
 */
    constructor(testName: string, types: Array<string>, subject: any, target: any, append: string|null){
        super(
